            ...
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                        ...
                        sshpass -p 'tomcat' scp **/target/*.war tomcat@${params.tomcat_stg}:'/opt/middleware/tomcat/apache-tomcat-8.5.33/webapps'
                    }
                }
                ...
                stage ("Deploy to Production"){
                    steps {
                        ...
                        sshpass -p 'tomcat' scp **/target/*.war tomcat@${params.tomcat_prd}:'/opt/middleware/tomcat/apache-tomcat-8.5.33/webapps'
                    }
                }
            }
        }
